...
func (mg *RawGroup) GetTerraformResourceType() string {
	return "nexus_repository_raw_group"
}
...
// LateInitialize this RawGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RawGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &RawGroupParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
func (mg *RawProxy) GetTerraformResourceType() string {
	return "nexus_repository_raw_proxy"
}
...
// LateInitialize this RawProxy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RawProxy) LateInitialize(attrs []byte) (bool, error) {
	params := &RawProxyParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
